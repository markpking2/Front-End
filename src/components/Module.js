    ...
    return ( 
      ...
      >
        ...
        <StyledForm onSubmit={handleSubmit}>
            <StyledDiv>
            <FormHeading>You are about to have a hard conversation.</FormHeading>
                {!sent && <>
                <p style={{'color': 'rgba(42, 72, 78, 1)', 'textAlign' : 'left'}}>Fill out the form below with your unique token and click complete.</p>
                <p style={{'color': 'rgba(42, 72, 78, 1)', 'textAlign' : 'left'}}> We will notify the other party that you are ready to have a conversation.</p>
