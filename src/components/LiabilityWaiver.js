  ...
  return (
    ...
    >
      <div>
        <LiabilityContainer>
          <ArrowDiv>
            <Link to="/form/namephone">
              <FaIcon icon={faArrowAltCircleLeft} className="fa-3x" />
            </Link>
          </ArrowDiv>
          <div style={{ padding: "4rem" }}>
            ...
            <FormParagraph>
              ...
              the use of Empowered Conversation's Website, located at
              /empoweredconversation.com.
            </FormParagraph>

            <FormParagraph>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Empowered Conversation if you
              do not agree to take all of the terms and conditions stated on
              this page. Our Terms and Conditions were created with the help of
              the{" "}
              <StyledA href="https://www.termsandconditionsgenerator.com">
            ...
            <FormParagraph>
              We employ the use of cookies. By accessing Empowered Conversation,
              you agreed to use cookies in agreement with the Empowered
              Conversation's Privacy Policy.
            </FormParagraph>
            ...
            <FormParagraph>
              Unless otherwise stated, Empowered Conversation and/or its
              licensors own the intellectual property rights for all material on
              Empowered Conversation. All intellectual property rights are
              reserved. You may access this from Empowered Conversation for your
            ...
            <ul>
              <FormListItem>
                Republish material from Empowered Conversation
              </FormListItem>
              <FormListItem>
                Sell, rent or sub-license material from Empowered Conversation
              </FormListItem>
              <FormListItem>
                Reproduce, duplicate or copy material from Empowered
                Conversation
              </FormListItem>
              <FormListItem>
                Redistribute content from Empowered Conversation
              </FormListItem>
            </ul>
            ...
            <FormParagraph>
              ...
              Empowered Conversation does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Empowered Conversation,its
              ...
              permitted by applicable laws, Empowered Conversation shall not be
            ...
            <FormParagraph>
              Empowered Conversation reserves the right to monitor all Comments
            ...
            <FormParagraph>
              You hereby grant Empowered Conversation a non-exclusive license to
            ...
            <FormParagraph>
              ...
              Empowered Conversation; and (d) the link is in the context of
            ...
            <FormParagraph>
              ...
              by sending an e-mail to Empowered Conversation. Please include
            ...
            <FormParagraph>
              No use of Empowered Conversation's logo or other artwork will be
        ...
        <AcceptDiv>
          <FormParagraph>
            You understand that by clicking on the "I Accept & Continue" button
            below, you are agreeing to Empowered Conversation's Terms and
            Conditions of using this tool.
          </FormParagraph>
        </AcceptDiv>
        <Link to="/form/submit">
          <StyledButton>I Accept & Continue</StyledButton>
        </Link>
      </div>
    </CSSTransition>
  );
